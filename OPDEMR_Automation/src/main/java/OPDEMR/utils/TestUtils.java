...
//		return stripped.replaceAll("\\r\\n|\\r|\\n", " ");
	 ...
	 * @return the random int
	 */
	public static String getRandomIntb(Integer... limit) {
		Integer bound;
		String str = "";
		if ((bound = getFirstValueOr(limit, null)) != null) {
			str = Integer.toString(random.nextInt(bound));
	...
	public static String generate10DigitNumber() {
		...
		String str = "";
		long n = 700000000 + r.nextInt(2000000000);
		if (n < 0) {
			n = -n;
		}
		return str = Long.toString(n);
	}

	
	public static String generate10DigitNumberNewMethod()
	{
		String str="";
		long first14 = (long) (Math.random() * 100000000L);
		
		long number = 7200000000L + first14;
		
		return str=Long.toString(number);
	}
